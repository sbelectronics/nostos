; Like 512K-SIO but using Scott Baker's port numbers, which 
; differ from RC2014 board's standard port numbers.
...
physdev_sioa:
    PDTENTRY_SIO PHYSDEV_ID_SIOA, "SIOA", SIO_SB_CTRL_A, SIO_SB_DATA_A, SIO_8N1_DIV64
physdev_siob:
    PDTENTRY_SIO PHYSDEV_ID_SIOB, "SIOB", SIO_SB_CTRL_B, SIO_SB_DATA_B, SIO_8N1_DIV64
