; 512K ROM variant for SCC UART with CompactFlash storage.
...
; --- Build-flag assertions (see mapper_config.asm for sentinel contract) ---
    IFNDEF MAPPER_74HCT670_CHOSEN
        ERROR "512k-scc bootstrap requires the default 74HCT670 mapper (no -DMAPPER_NONE or -DMAPPER_Z180_MMU)"
    ENDIF
