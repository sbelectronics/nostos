...
physdev_tty0:
    PDTENTRY_SIO PHYSDEV_ID_SIOA, "TTY0", SIO_CTRL_A, SIO_DATA_A, SIO_8N1_DIV64
physdev_tty1:
    PDTENTRY_SIO PHYSDEV_ID_SIOB, "TTY1", SIO_CTRL_B, SIO_DATA_B, SIO_8N1_DIV64
physdev_net0:
    PDTENTRY_SIO PHYSDEV_ID_NETA, "NET0", NET_CTRL_A, NET_DATA_A, SIO_8N1_DIV64
physdev_net1:
    PDTENTRY_SIO PHYSDEV_ID_NETB, "NET1", NET_CTRL_B, NET_DATA_B, SIO_8N1_DIV64
...
logdev_init_table:
    ...
    DEFB PHYSDEV_ID_SIOA, 0     ; PhysID, pad
    ...
    DEFB PHYSDEV_ID_SIOB, 0     ; PhysID, pad
...
; --- Build-flag assertions (see mapper_config.asm for sentinel contract) ---
    IFNDEF MAPPER_74HCT670_CHOSEN
        ERROR "512k-piconet-fdc bootstrap requires the default 74HCT670 mapper (no -DMAPPER_NONE or -DMAPPER_Z180_MMU)"
    ENDIF
