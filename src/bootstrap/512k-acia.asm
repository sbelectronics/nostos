...
;physdev_sioa:
;    PDTENTRY_SIO PHYSDEV_ID_SIOA, "SIOA", SIO_CTRL_A, SIO_DATA_A, SIO_8N1_DIV64
;physdev_siob:
;    PDTENTRY_SIO PHYSDEV_ID_SIOB, "SIOB", SIO_CTRL_B, SIO_DATA_B, SIO_8N1_DIV64
...
; --- Build-flag assertions (see mapper_config.asm for sentinel contract) ---
    IFNDEF MAPPER_74HCT670_CHOSEN
        ERROR "512k-acia bootstrap requires the default 74HCT670 mapper (no -DMAPPER_NONE or -DMAPPER_Z180_MMU)"
    ENDIF
